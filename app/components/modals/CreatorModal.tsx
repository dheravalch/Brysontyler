...
export default function CreatorProfileModal({
  ...
  useScrollLock(isOpen || showSubscribe);
  ...
  return (
    <div className="fixed top-0 inset-0 bg-black/95 z-[100] flex items-center justify-center p-4 backdrop-blur-md overflow-y-auto">
      {showSubscribe ? (
        <SubscribeModal
        ...
        <div className="relative bg-zinc-950 w-full max-w-5xl rounded-3xl overflow-hidden border border-white/5 shadow-2xl z-10 my-8">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-50 bg-black/60 hover:bg-black text-white p-2.5 rounded-full border border-white/5 transition-colors"
          >
            <X size={20} />
          </button>
          ...
          <div className="px-8 pb-6 -mt-16 relative z-10 border-b border-white/5">
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-end">
              <div className="w-36 h-36 rounded-2xl border-4 border-zinc-950 overflow-hidden relative bg-zinc-800 shadow-2xl flex-shrink-0">
                <Image
                  src={creator.avatar}
                  alt={creator.name}
                  fill
